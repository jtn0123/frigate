...
if [ -e /usr/local/cuda-12 ]; then
    ...
    # assume Jetpack 4.X
    curl --proto '=https' --proto-redir '=https' -fsSL --output jetson_multimedia_api.tbz2 https://developer.nvidia.com/embedded/L4T/r32_Release_v5.0/T186/Jetson_Multimedia_API_R32.5.0_aarch64.tbz2
    tar xaf jetson_multimedia_api.tbz2 -C / && rm jetson_multimedia_api.tbz2
else
    # assume Jetpack 5.X
    curl --proto '=https' --proto-redir '=https' -fsSL --output jetson_multimedia_api.tbz2 https://developer.nvidia.com/downloads/embedded/l4t/r35_release_v3.1/release/jetson_multimedia_api_r35.3.1_aarch64.tbz2
    tar xaf jetson_multimedia_api.tbz2 -C / && rm jetson_multimedia_api.tbz2
fi

curl --proto '=https' --proto-redir '=https' -fsSL --output jetson-ffmpeg.zip https://github.com/AndBobsYourUncle/jetson-ffmpeg/archive/9c17b09.zip
...
curl --proto '=https' --proto-redir '=https' -fsSL --remote-name https://github.com/FFmpeg/nv-codec-headers/archive/refs/heads/master.zip
...
curl --proto '=https' --proto-redir '=https' -fsSL --remote-name https://ffmpeg.org/releases/ffmpeg-6.0.tar.xz
