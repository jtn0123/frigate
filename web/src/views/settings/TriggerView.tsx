...
import TriggersSemanticSearchNotice from "@/components/fork/settings/TriggersSemanticSearchNotice";
        ...
        {!isSemanticSearchEnabled ? (
          <div className="mb-5 flex flex-row items-center justify-between gap-2">
            <div className="flex flex-col items-start">
              ...
              {/* fork: a neutral prerequisite notice, not an error (UI104) */}
              <TriggersSemanticSearchNotice
                docsUrl={getLocaleDocUrl("configuration/semantic_search")}
              />
            </div>
          </div>
        ) : (
