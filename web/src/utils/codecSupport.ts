...
const CODEC_MIME_SAMPLES: Partial<Record<string, string[]>> = {
...
const FAMILY_ALIASES: Partial<Record<string, string>> = {
  avc: "h264",
  avc1: "h264",
  h265: "hevc",
  hev1: "hevc",
...
function canPlayMimeType(mimeType: string): boolean {
  ...
  const mediaSource = (window as { MediaSource?: typeof MediaSource })
    .MediaSource;
