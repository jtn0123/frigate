...
| G | Performance & Scalability | C+ | B− | C+ | 9 |
| H | Documentation & Onboarding | C | C+ | C+ | 5 |
| I | Developer Experience & Tooling | C+ | B | B | 8 |
| **Overall** | | **B−** | **B** | **B** | **65** + UX track |

**What the grade branch added (2026-09-18).** E6 and G8 are done, I3's first wave and G9's image half landed, and the rest of its work is ledger-only (I17, D25, D26, I16, E8, plus F10 and B10, which were this branch's F7 and B5 until `next` claimed those numbers for different items; the trunk keeps the number).
