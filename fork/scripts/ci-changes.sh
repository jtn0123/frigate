...
shared='^(\.coveragerc$|sonar-project\.properties$|fork/requirements-(sonar|audit)\.txt$|fork/audit-exceptions\.json$|\.github/workflows/fork-checks\.yml|\.github/actions/fork-web-setup/|fork/scripts/ci-)'
web_re="${shared}|^web/"
